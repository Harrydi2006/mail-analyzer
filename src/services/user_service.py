...
class UserService:
    ...
    def register_user(self, username: str, email: str, password: str, invitation_code: str) -> Dict[str, Any]:
        ...
        try:
            ...
            user_id = self.db.execute_update(query, (username, email, password_hash, subscribe_key, invitation_code, is_admin))
    ...
    def generate_invitation_code(self, created_by: int, max_uses: int = 1, expires_days: int = 30, user_role: str = 'user') -> Dict[str, Any]:
        ...
        try:
            ...
            code_id = self.db.execute_update(query, (code, created_by, max_uses, expires_at, user_role))
