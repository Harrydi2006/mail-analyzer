...
public class GetuiSdkDemoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public HomeFragment homeFragment = HomeFragment.newInstance(); //用于保存状态
    public AdvancedFunctionFragment advancedFunctionFragment = AdvancedFunctionFragment.newInstance();
    public AppInfoFragment appInfoFragment = AppInfoFragment.newInstance();
    ...
    private void selectFragment(String tag) {
        ...
        if (tag.equals(HOME)) {
            ...
            currentFragment = advancedFunctionFragment;
